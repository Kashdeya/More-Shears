package com.kashdeya.moreshears.util;
...
public class RecipeRegistry
{
    public static void addShapedRecipe(ItemStack output, Object... inputs)
    {
        ...
        ResourceLocation tempName = name;
        
        while(CraftingManager.REGISTRY.containsKey(tempName))
        {
            tempName = new ResourceLocation(name.getResourceDomain(), String.format("%s.%d", name.getResourcePath(), recipeIndex++));
        }
        
        addShapedRecipe(tempName.toString(), output, inputs);
    }
    ...
    public static void addShapelessRecipe(ItemStack output, Object... inputs)
    {
        ...
        addShapelessRecipe(tempName.toString(), output, inputs);
    }
